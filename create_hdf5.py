...
parser.add_argument('--CXR_dataset', type=str, default='mimic')
args = parser.parse_args()

IMG_DIR = f'./VQ-VAE-2-Images/1024/frontal/original'
DATA_DIR = f'./VQ-VAE-2-Images'
HDF5_DIR = './HDF5_datasets'
...
for mode in ['valid', 'train']:
    ...
    for view in ['frontal']:
        ...
        image_list_file = f'{DATA_DIR}/image_labels.csv'
