...
# Define dataset
dataset = {}
dataset['train'] = ChestXrayHDF5(f'{args.data_path}/{args.dataset}_train_{args.size}_frontal_normalized.hdf5')
dataset['valid'] = ChestXrayHDF5(f'{args.data_path}/{args.dataset}_valid_{args.size}_frontal_normalized.hdf5')
dataloaders = {}
...
for phase in ['train', 'valid']:
    ...
    hdf5_latent.create_dataset('img', (len(dataset[phase]), 128, 64, 64))
