...
parser.add_argument('--n_epochs', type=int, default=9)
...
parser.add_argument('--dataset', type=str, default='mimic', help="CheXpert or mimic")
        ...
        for i, (img, label) in enumerate(loader):
            ...
            with torch.set_grad_enabled(phase == 'train'):
                ...
                if phase == 'train':
                    ...
                    optimizer.step()
                    #for gpu
                    #losses[0, epoch, :] =  [loss.detach().cpu().numpy(), recon_loss.detach().cpu().numpy(), latent_loss.detach().cpu().numpy()]
                    #for cpu
